      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">
            Kelola semua lowongan kerja yang sudah kamu posting
          </p>
        </div>
        <Link
          to="/company/add-job"
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 text-white font-medium hover:from-blue-600 hover:to-purple-600 transition shadow-sm"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {jobs.map((job) => (
            ...
            >
              ...
              {/* Job Type Badge */}
              <div className="mb-4">
                <span className={`inline-block px-2.5 py-1 rounded-full text-xs font-medium border ${getTypeBadge(job.job_type)}`}>
                  {job.job_type}
                </span>
              </div>
