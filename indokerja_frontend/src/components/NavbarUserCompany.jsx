  ...
  return (
    <nav className="w-full border-b px-8 py-4 flex items-center bg-white">
      ...
      <div className="flex-1">
        <Link to="/company/home" className="text-xl font-bold flex items-center gap-2">
      ...
      <div className="flex gap-4 flex-1 justify-center">
        <NavLink to="/company/home" className={navClass}>
          <FaBook />
          Home
        </NavLink>

        <NavLink to="/company/application-list" className={navClass}>
          <FaBook />
          Applications
        </NavLink>
      </div>
...
export default NavbarUserCompany;
